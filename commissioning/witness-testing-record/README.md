# witness-testing-record — DraftsMan MEP Engineering Skill

**Status:** Stub — contributions welcome
**Discipline:** commissioning
**Standards:** CIBSE Commissioning Code C, BS 5839-1 §44, BS EN 12845 §20
**Output:** JSON IR

## What this skill does
Witness test record for client/consultant sign-off of critical systems (RCDs, fire alarm, sprinkler, BMS points)
