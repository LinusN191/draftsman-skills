# inspection-test-certificate — DraftsMan MEP Engineering Skill

**Status:** Stub — contributions welcome
**Discipline:** commissioning
**Standards:** BS 7671:2018+A2:2022 Part 6, IET GN3
**Output:** JSON IR

## What this skill does
BS 7671 Part 6 Electrical Installation Certificate (EIC) / Electrical Installation Condition Report (EICR) generation from project IR
