# integrated-design-review — DraftsMan MEP Engineering Skill

**Status:** Stub — contributions welcome
**Discipline:** compliance
**Standards:** RIBA Plan of Work Stage 4 sign-off, BSRIA BG 6, ISO 19650, CIBSE Code M, CDM 2015 Designer duties
**Output:** JSON IR

## What this skill does
Integrated whole-package design-review sign-off — coordinated cross-discipline compliance verdict, chartered-engineer integration check across all skills
