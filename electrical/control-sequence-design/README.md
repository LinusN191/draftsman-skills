# control-sequence-design — DraftsMan MEP Engineering Skill

**Status:** Stub — contributions welcome
**Discipline:** electrical
**Standards:** IEC 61131-3, BS EN 60204-1, IEEE C37.2 (device numbers), IEC 60947
**Output:** JSON IR

## What this skill does
Sequence-of-operations + relay/PLC logic ladder design for switchgear, BMS interlocks, ATS changeover, motor-control schemes. Adjacent to but distinct from schematic (which captures the topology); this skill owns the LOGIC/SEQUENCE deliverable. IEC 61131 programming-language overlap.
