# ev-charging — DraftsMan MEP Engineering Skill

**Status:** Stub — contributions welcome
**Discipline:** electrical
**Standards:** IEC 61851, BS 7671 §722, IET Code of Practice for EV Charging Equipment Installation 5th ed, OZEV grant compliance
**Output:** JSON IR

## What this skill does
EV charging infrastructure sizing, circuit configuration and load management (Mode 3 AC + Mode 4 DC)
