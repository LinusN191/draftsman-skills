# protection-coordination — DraftsMan MEP Engineering Skill

**Status:** Stub — contributions welcome
**Discipline:** electrical
**Standards:** IEC 60364-5-53, IEC 60947-2, IEEE Std 242 (Buff Book), BS 7671 §536
**Output:** JSON IR

## What this skill does
Full network time-current discrimination (TCC) study across the protection cascade with grading verdicts per device pair
