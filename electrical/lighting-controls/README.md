# lighting-controls — DraftsMan MEP Engineering Skill

**Status:** Stub — contributions welcome
**Discipline:** electrical
**Standards:** BS EN IEC 62386 (DALI), BS EN 50090 (KNX), Approved Document L 2021, CIBSE Applications Manual AM10
**Output:** JSON IR

## What this skill does
Lighting control system design — DALI/KNX bus topology, daylight zoning, occupancy zoning, scene programming. Produces controls intent + Part L control-point compliance report. Distinct from lighting-layout (placement) and from small-power (general accessories).
